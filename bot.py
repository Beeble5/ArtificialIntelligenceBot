...
while True:
    user_input.lower() = input("Enter something: ")
    if user_input.lower() == 'hi' or user_input.lower() == 'hello':
        ...
        user_input.lower() = input("Type something: ")
        if user_input.lower() == 'yes':
            print(random.choice(jokes))
    elif user_input.lower() == "good" or user_input.lower() == "super" or user_input.lower() == "great" or user_input.lower() == "fine":
            print("That's good")
